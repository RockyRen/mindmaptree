...
var ChildrenRenderFactory = (function(){
    return {
        createRenderStrategy: function(node, drawNode){
            var strategy;
 ...
 * @constructor
 */
function AbstractRender(drawNode) {
 ...
 * @constructor
 */
function FirstLevelRender(drawNode){
 ...
 * 第n(n>=2)层子节点渲染类
 */
function SecondAndMoreRender(drawNode){
    this.nodeXInterval = 14;
    this.drawNode = drawNode;
}
